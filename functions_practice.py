#create the following functons:
#A function named hello() that prints a greeting to the user. This function should accept no arguments and returns nothing.
def hello():
    print('Hello, user')

 #a function named pack() that accepts three arguments, and returns a singe list with the three arguments inside as list elements.
def pack(a,b,c):
  returns [a,b,c]
